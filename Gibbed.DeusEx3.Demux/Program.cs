...
namespace Gibbed.DeusEx3.Demux
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.DeusEx3.Demux.exe
        ...
        // "Gibbed.DeusEx3.Demux.dll" rather than the real executable name. Falls back to
