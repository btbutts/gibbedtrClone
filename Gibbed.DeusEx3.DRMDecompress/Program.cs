...
namespace Gibbed.DeusEx3.DRMDecompress
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.DeusEx3.DRMDecompress.exe
        ...
        // "Gibbed.DeusEx3.DRMDecompress.dll" rather than the real executable name. Falls back
