...
namespace Gibbed.TombRaider.Pack
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.TombRaider.Pack.exe
        ...
        // "Gibbed.TombRaider.Pack.dll" rather than the real executable name. Falls back to
