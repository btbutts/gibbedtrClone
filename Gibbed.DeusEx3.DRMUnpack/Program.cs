...
namespace Gibbed.DeusEx3.DRMUnpack
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.DeusEx3.DRMUnpack.exe
        ...
        // "Gibbed.DeusEx3.DRMUnpack.dll" rather than the real executable name. Falls back to
