...
namespace Gibbed.TombRaider.DRMEdit
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.TombRaider.DRMEdit.exe
        ...
        // "Gibbed.TombRaider.DRMEdit.dll" rather than the real executable name. Falls back to
