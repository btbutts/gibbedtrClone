...
namespace Gibbed.TombRaider.RebuildFileLists
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.TombRaider.RebuildFileLists.exe
        ...
        // "Gibbed.TombRaider.RebuildFileLists.dll" rather than the real executable name. Falls
        // back to the old behavior only if ProcessPath is ever unavailable (hosting edge case).
