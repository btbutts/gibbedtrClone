...
namespace Gibbed.DeusEx3.Unpack
{
    ...
    {
        // Environment.ProcessPath is the real running apphost (Gibbed.DeusEx3.Unpack.exe
        ...
        // "Gibbed.DeusEx3.Unpack.dll" rather than the real executable name. Falls back to
